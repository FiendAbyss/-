...
HD_PWD='C:/Users/Abyss/Desktop/vivado/lab1_sk2/lab1_sk2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decode32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decode32.tcl -notrace
