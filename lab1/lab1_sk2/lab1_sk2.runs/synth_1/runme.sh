...
HD_PWD='C:/Users/Abyss/Desktop/vivado/lab1_sk2/lab1_sk2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decode32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decode32.tcl
