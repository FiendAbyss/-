...
HD_PWD='C:/Users/Abyss/Desktop/vivado/lab1_sk1/lab1_sk1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compare32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compare32.tcl
