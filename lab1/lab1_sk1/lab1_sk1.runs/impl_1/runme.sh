...
HD_PWD='C:/Users/Abyss/Desktop/vivado/lab1_sk1/lab1_sk1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log compare32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source compare32.tcl -notrace
