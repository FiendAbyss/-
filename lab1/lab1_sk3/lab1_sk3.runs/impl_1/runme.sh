...
HD_PWD='C:/Users/Abyss/Desktop/vivado/lab1_sk3/lab1_sk3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log number.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source number.tcl -notrace
